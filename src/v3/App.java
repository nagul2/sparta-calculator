    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (firstValue instanceof Double || secondValue instanceof Double) {
                calculator.doubleCalculate(validOperator.getSymbol(), firstValue.doubleValue(), secondValue.doubleValue());
            } else {
                calculator.intCalculate(validOperator.getSymbol(), firstValue.intValue(), secondValue.intValue());
            }
